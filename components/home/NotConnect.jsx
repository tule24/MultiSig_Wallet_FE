...
const NotConnect = () => {
    return (
        <div className="flex items-center h-full w-full sm:p-16 dark:bg-gray-900 dark:text-gray-100 my-20">
            <div className="flex flex-col items-center justify-center mx-auto my-8 space-y-8 text-center">
                ...
                <p className="text-3xl">Looks like you're not connect wallet to this page</p>
                <p className="text-3xl">Please connect your wallet to use this feature</p>
            </div>
        </div>
    )
}
